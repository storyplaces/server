...
var rolesToPrivileges = {
    ...
    "admin": ["getReviewStories", "updateReadingStoryPublishStatus", "deleteReadingStory", "previewAnyStory", "adminMenu", "fetchAnyStory", "requestPublicationOfAnyStory", "requestPreviewOfAnyStory", "editAnyStory", "getAnyImage", "uploadAnyImage", "getUserList", "assignUserRoles"]
};
